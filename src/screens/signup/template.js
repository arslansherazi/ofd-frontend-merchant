...
export const template = component =>
{
    ...
    if (component.state.isNameVerified)
        name = <div class="d-flex flex-column required_message_container">
            <input type="text" name="name" className="nbs_input" placeholder="name e.g Pizza Hut" onChange={component.handleValue} />
        </div>
    else
        name = <div class="d-flex flex-column required_message_container">
            <input type="text" name="name" className="nbs_input_red" placeholder="name e.g Pizza Hut" onChange={component.handleValue} />
    ...
    if (component.state.isEmailVerified)
        email = <div class="d-flex flex-column required_message_container">
            <input type="text" name="email" className="nbs_input" placeholder="email" onChange={component.handleValue}/>
        </div>
    else
        email = <div class="d-flex flex-column required_message_container">
            <input type="text" name="email" className="nbs_input_red" placeholder="email" onChange={component.handleValue}/>
    ...
    if (component.state.isUsernameVerified)
        username = <div class="d-flex flex-column required_message_container">
            <input type="text" name="username" className="nbs_input" placeholder="username" onChange={component.handleValue} />
        </div>
    else
        username = <div class="d-flex flex-column required_message_container">
            <input type="text" name="username" className="nbs_input_red" placeholder="username" onChange={component.handleValue} />
    ...
    if (component.state.isProfilePictureVerified)
        ...
        profilePicture = <div class="d-flex flex-column required_message_container">
            <div id="upload_image_container_red" className="d-flex flex-column align-items-start">
                <label id="upload_image_label">Upload profile picture</label>
                <input type="file" name="profilePicture" onChange={component.handleProfilePicture} />
            </div>
    ...
    {
        var openingDaysContent = <div id="opening_days_sub_container" className="d-flex flex-row flex-wrap">
